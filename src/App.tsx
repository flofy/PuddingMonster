...
import { WORLDS, getLevel, Pudding, Star, GameState, BOARD_WIDTH, BOARD_HEIGHT, WorldTheme } from './types';
...
const App: React.FC = () => {
      ...
      const timer = setTimeout(() => {
        ...
        if (nextLevelIndex < currentWorld.levels.length) {
          ...
          if (nextWorldIndex < WORLDS.length) {
            ...
            alert('Congratulations! You have completed all worlds!');
          }
        }
      }, 1500);
    ...
    if (puddings.some(p => p.isMoving)) {
      const animationId = requestAnimationFrame(() => {
        setPuddings(prev => {
          ...
          if (!hasMoving) {
            checkCollisions(prev, setPuddings);
          }
  ...
  const checkCollisions = (currentPuddings: Pudding[], setPuddings: React.Dispatch<React.SetStateAction<Pudding[]>>) => {
  ...
  const getThemeColors = () => {
    switch (boardTheme) {
      case 'forest':
        return {
          board: '#1a3d2a',
          puddingNormal: '#d62828',
          puddingGreen: '#059669',
          puddingPurple: '#7c3aed',
          star: '#fbbf24',
        };
      case 'desert':
        return {
          board: '#374151',
          puddingNormal: '#dc2626',
          puddingGreen: '#16a34a',
          puddingPurple: '#9333ea',
          star: '#fbbf24',
        };
      case 'ice':
        return {
          board: '#0f172a',
          puddingNormal: '#ef4444',
          puddingGreen: '#22c55e',
          puddingPurple: '#a855f7',
          star: '#fbbf24',
        };
      case 'volcano':
        return {
          board: '#1f2937',
          puddingNormal: '#fca5a5',
          puddingGreen: '#4ade80',
          puddingPurple: '#c084fc',
          star: '#fbbf24',
        };
      case 'space':
        return {
          board: '#0f0f23',
          puddingNormal: '#f87171',
          puddingGreen: '#34d399',
          puddingPurple: '#a78bfa',
          star: '#fbbf24',
        };
      default:
        return {
